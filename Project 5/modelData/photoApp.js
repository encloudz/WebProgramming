...
(function() {
   ...
   var pt = {_id: "57231f1a30e4351f4e9f4bd9", first_name: "Peregrin", last_name: "Took", 
             ...
             "all shall fade... all... shall... fade... ", occupation: "Mechanist"};
   var rk = {_id: "57231f1a30e4351f4e9f4bda", first_name: "Rey", last_name: "Kenobi", 
             location: "D'Qar", description: "Excited to be here!", occupation: "Priest"};
   var al = {_id: "57231f1a30e4351f4e9f4bdb", first_name: "April", last_name: "Ludgate", 
             location: "Pawnee, IN", description: "Witch", occupation: "Public Relation"};
   var jo = {_id: "57231f1a30e4351f4e9f4bdc", first_name: "John", last_name: "Ousterhout",
             location: "Stanford, CA", description: "<i>CS142!</i>", occupation: "Doctor"};
   ...
   var comment1 = {
      ...
      comment: "Learning brand new things is kinda hard to me... " + 
      "Also, it's so easy to forget a </div>!", user: jo, photo_id: photo1._id
   };

   var comment2 = {
      _id: "57231f1a30e4351f4e9f4bea",
      date_time: "2013-09-06 14:02:00",
      comment: "This is a comment with a bit more text; " +
      "the text gets long and long, does it wrap properly " +
